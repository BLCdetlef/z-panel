...
"""ZUSTAND News Studio 5.4.2 – responsive Oberfläche.
...
class NewsStudio54(base53.NewsStudio53):
    def __init__(self):
        super().__init__()
        self.title("ZUSTAND News Studio 5.4.2")
        self._replace_widget_text("ZUSTAND News Studio 5.3", "ZUSTAND News Studio 5.4.2")
