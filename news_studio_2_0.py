...
class NewsStudio(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("ZUSTAND News Studio 2.0")
    ...
    def _build(self):
        ...
        header.pack(fill="x")
        ttk.Label(
            header, text="ZUSTAND News Studio 2.0",
    ...
    def _build_overview(self):
        ...
        text = (
            "1. Im Recherche-Assistenten seriöse Quellen öffnen oder den Morgen-Prompt kopieren.\n"
