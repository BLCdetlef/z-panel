...
class NewsStudio(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("ZUSTAND News Studio 4.8")
        ...
        if total_content == 0:
            messagebox.showwarning(
                ...
                (
                    ...
                    "Bitte prüfe, ob News Studio 4.8 im richtigen Projektordner liegt. "
    ...
    def _build(self):
        ...
        header.pack(fill="x")
        ttk.Label(
            header, text="ZUSTAND News Studio 4.8",
    ...
    def _build_overview(self):
        ...
        ttk.Button(
            actions, text="2. Neuen Beitrag anlegen",
            command=self.new_article
        ).pack(side="left", padx=8)
        ttk.Button(
            actions, text="3. Veröffentlichen",
        ...
        text = (
            ...
            "2. Ausgewählte Meldungen als Entwürfe übernehmen oder neu anlegen.\n"
    ...
    def build_research_prompt(self, period: str) -> str:
        ...
        return (
            ...
            "die ausgewählten Meldungen als importfähige ZUSTAND-Entwürfe mit automatisch "
            "vergebenen IDs nach der bestehenden Logik. Stelle die Importdatei zum Herunterladen bereit."
        )
