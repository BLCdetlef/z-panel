...
def inspect_release(write_output: bool = False):
    """Prüft die Veröffentlichung; schreibt nur auf ausdrücklichen Wunsch."""
    errors = []
    warnings = []
    source_ids = set()
    source_files = []
...
def fetch_remote_news(url: str):
    ...
    request = urllib.request.Request(
        request_url,
        headers={
            "User-Agent": "ZUSTAND-News-Studio/4.3",
...
class NewsStudio(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("ZUSTAND News Studio 4.3")
        ...
        if total_content == 0:
            messagebox.showwarning(
                ...
                (
                    ...
                    "Bitte prüfe, ob News Studio 4.3 im richtigen Projektordner liegt. "
    ...
    def _build(self):
        ...
        header.pack(fill="x")
        ttk.Label(
            header, text="ZUSTAND News Studio 4.3",
    ...
    def _build_generator(self):
        ...
        remote_box.pack(fill="x", pady=(0, 8))
        ...
        self.generator_log.pack(fill="both", expand=True, pady=(4, 10))
